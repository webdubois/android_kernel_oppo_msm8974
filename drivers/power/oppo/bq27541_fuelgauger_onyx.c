...
#if defined (CONFIG_MACH_ONYX) || defined (CONFIG_OPPO_MSM_14021)
static bool bq27541_authenticate(struct i2c_client *client)
{
	return true;
}
...
#else //defined (CONFIG_MACH_ONYX) || defined (CONFIG_OPPO_MSM_14021)
...
#endif //defined (CONFIG_MACH_ONYX) || defined (CONFIG_OPPO_MSM_14021)
#endif //CONFIG_MACH_ONYX
...
#ifdef CONFIG_MACH_ONYX
/* add by yangrujin@bsp 2015/9/16, if device is 15055, not register bq27541*/
